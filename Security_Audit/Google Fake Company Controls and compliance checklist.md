...
\> Most importantly encrypt all cardholder data and customer PII/SPII.

\> Implement controls for Least privilege and separation of duties

\> Stronger password policies for employees

\> Have better threat detection and disaster recovery systems in place
