...
[Template](https://docs.google.com/document/d/1EnieOKYJyKGsVff5Gg-3-dVwrHrZ2m8Hig6tVpfKqyg/template/preview?usp=sharing&resourcekey=0-eb5t-d69zTPLEGthIpVlXw)
...
- [x] Your incident report identifies the type of attack and extent of the incident, including which devices and/or systems in the network were impacted by the security event.
- [x] Your incident report offers a plan to protect the network from future incidents.
- [x] Your incident report describes methods for detecting security events in the future.
- [x] Your incident report outlines a process your organization can use to respond to similar cybersecurity incidents in the future
- [x] Your incident report lists procedures to recover from a similar security event. 
